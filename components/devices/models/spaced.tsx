...
export default function DeviceSpaced() {
    return (
                ...
                <div className="devPage">
                    ...
                    <div className='devContainer mt-[4vh] rounded-[10px] p-3'>
                        ...
                        <div className='flex items-center mt-3 gap-3 dlBtns'>
                            <Link href='https://r2.originui.dev/devices/lineage_spaced-ota.zip' target='_blank' className='w-full flex items-center justify-center'>
